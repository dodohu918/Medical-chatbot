// Version 10.0 (from ver 9.0)
// Skip user email when sending api to openai
// Add a get_duration node near the end of the flow_base.json
    ...
    case "open-ended": {
      ...
      if (currentNodeId === "get_duration") {
        ...
        if (!durationRegex.test(rawDuration)) {
          ...
          return [currentNodeId, "格式不正確，請輸入像 2小時, 3天, 1週, 2月 這樣的格式："];
        }
