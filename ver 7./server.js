// Version 7.0
// Add the function of sending the input to a google sheet
// You have to do the "npm install firebase-admin" inside this project first
...
// Start playing with firebase
const admin = require("firebase-admin");  // <-- Import firebase-admin
const serviceAccount = require("../medpal-7e189-firebase-adminsdk-ki0gk-d8e3ac0976.json");
// Initialize the Firebase Admin SDK
admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  // If you need Firestore URLs or storageBucket, add them here:
...
app.post("/chatbot", async (req, res) => {
  ...
  try {
    ...
    // Suppose inside your /chatbot POST route after you parse user input:
    await db.collection("chatLogs").add({
      user_id,
      node_id: currentNode,
      question: node.question,
      user_answer: chosenLabel || userRawMessage,
